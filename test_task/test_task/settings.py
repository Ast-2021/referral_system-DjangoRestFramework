...
SECRET_KEY = 'django-insecure-o*2h1#q4rmvbub!qf$=7k7q#f3kqnr9uaqq+9z(h)t!sk4ms77'
...
MIDDLEWARE = [
    'referral_system.middleware.DisableCSRF',
...
AUTHENTICATION_BACKENDS = [
    'referral_system.backends.PhoneNumberBackend',
